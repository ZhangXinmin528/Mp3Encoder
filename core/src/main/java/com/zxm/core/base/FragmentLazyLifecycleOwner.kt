...
class FragmentLazyLifecycleOwner(private val mCallback: Callback) : LifecycleObserver,
    ...
    override fun getLifecycle(): Lifecycle {
        return getCurrLifecycle()
    }


//    override val lifecycle: Lifecycle
//        get() = getCurrLifecycle()

    private fun getCurrLifecycle(): Lifecycle {
        initialize()
    ...
    private fun handleLifecycleEvent(event: Lifecycle.Event) {
        ...
        Log.v(mCallback::class.java.simpleName, "handleLifecycleEvent()..${event.name}")
    }
